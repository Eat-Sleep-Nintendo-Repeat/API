...
app.get("/api", (req, res) => {
  res.send(
    "This is the official Eat, Sleep, Nintendo, Repeat API. You can find the Docs here: https://github.com/Eat-Sleep-Nintendo-Repeat/API/blob/main/API%20Documentation.md"
  );
});
